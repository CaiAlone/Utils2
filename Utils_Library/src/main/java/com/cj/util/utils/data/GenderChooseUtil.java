package com.cj.util.utils.data;
...
import com.cj.util.utils.interfaces.MyCallBack;
...
public class GenderChooseUtil {
    ...
    public static void initJsonData(Context context) {//解析数据
         ...
         *
         * */
        String JsonData = getJson(context, "gender.json");//获取assets目录下的json文件数据
